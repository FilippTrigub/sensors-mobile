...
install -m 0644 src/host_service/*.py %{buildroot}/usr/lib/cockpit-sensors/host_service/
install -d -m 0755 %{buildroot}/usr/lib/cockpit-sensors/host_service/fixtures
install -m 0644 src/host_service/fixtures/* %{buildroot}/usr/lib/cockpit-sensors/host_service/fixtures/
install -m 0644 src/host_service/requirements.txt %{buildroot}/usr/lib/cockpit-sensors/
